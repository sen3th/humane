...
It is built with [FastAPI](https://fastapi.tiangolo.com/) as the backend and [Svelte](https://svelte.dev/) as the frontend. The bots are powered by qwen3-32b provided free for teens by [HackClub](https://www.hackclub.com/). The backend is deployed on [Render](https://render.com/) and the frontend is deployed on [Netlify](https://www.netlify.com/).
